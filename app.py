...
# Импорт с обработкой ошибок для Streamlit Cloud
try:
    import matplotlib.pyplot as plt
except ImportError:
    plt = None
    st.warning("Matplotlib not available. Some charts may not work.")
...
try:
    ...
    st.warning("Scikit-learn not available. ML prediction will be disabled.")
...
# ============================================================
# 5. ПРЕДСКАЗАНИЕ ПРОДАЖ В ЯПОНИИ (если sklearn доступен)
# ============================================================
if SKLEARN_AVAILABLE:
    ...
    # График предсказаний (если matplotlib доступен)
    if plt:
...
with st.expander("About this app"):
    ...
    **Features:**
    - Data analysis with filtering
    - Japan sales prediction using Machine Learning
